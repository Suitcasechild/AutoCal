...
3.  **Robust Device Preparation:** The initialization of the DUT (Device Under Test) has been refactored to send commands individually with proper URL encoding, ensuring all settings reach the device correctly.
...
3.  **Robuste Gerätevorbereitung:** Die Initialisierung des Prüflings wurde überarbeitet. Befehle werden nun einzeln und mit korrekter URL-Kodierung gesendet, was Übertragungsfehler verhindert.
